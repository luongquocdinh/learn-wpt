<!-- /////////////////////////////////////////////////////////////////////////
  ...
  <footer id="footer">
    <div class="footer-inner">
      <h2><img src="<?php echo get_template_directory_uri(); ?>/images/footer_copy.png" width="349" alt="美しさを拓く。 MILBON"></h2>
      <div class="menu-block">
        <ul class="menu footer-column01">
          ...
          <li class="withSub"><a class="pageLink" href="./company/gaiyou.html">COMPANY<span></span></a>
            <ul>
              <li><a class="pageLink" href="./company/gaiyou.html">COMPANY PROFILE</a></li>
              <li><a class="pageLink" href="./company/history.html">OUR HISTORY</a></li>
              <li><a class="pageLink" href="./company/president.html">MESSAGE</a></li>
              <li><a class="pageLink" href="./company/office/">OUR OFFICE</a></li>
              <li><a class="pageLink" href="./company/factory.html">PRODUCTION POLICY</a></li>
            </ul>
          </li>
        ...
        <ul class="menu footer-column02">
          <li class="withSub"><a href="./beauty/">FOR HAIR DESIGNER<span></span></a>
            <ul>
              <li><a target="_blank" href="http://www.biyoshi-oen.jp/">Education Guidance</a></li>
              <li><a target="_blank" href="http://www.milbon-biyoshidoga.jp/">びよーしどーが</a></li>
              <li><a target="_blank" href="http://www.milbon.co.jp/photorevo_2016/">MILBON PHOTO REVOLUTION</a></li>
              <li><a target="_blank" href="http://www.milbon.co.jp/da_inspire/">MILBON DA-INSPIRE-2016</a></li>
        ...
        <ul class="menu footer-column03">
          <li class="withSub nolink"><a href="#">GROUP SITE<span></span></a>
            <ul>
              ...
              <li><a target="_blank" href="http://www.milbon.co.jp/recruit/">2017年度 新卒採用情報サイト</a></li>
            </ul>
          </li>
        ...
        <ul class="menu footer-column04">
          <li class="withSub nolink"><a href="#">BRAND SITE<span></span></a>
            <ul>
              ...
              <li><a target="_blank" href="http://seasonhaircolor.com/">オルディーブ</a></li>
            </ul>
          </li>
          <li class="pb withSub nolink"><a href="#">SNS<span></span></a>
            <ul>
              <li><a target="_blank" href="https://www.facebook.com/milbonfordesigner/">facebook</a></li>
    ...
    <div class="footer-bottom">
      <ul>
        <li><a class="pageLink" href="./guide/require.html">ご利用条件</a></li>
        <li><a class="pageLink" href="./guide/privacy.html">プライバシーポリシー</a></li>
