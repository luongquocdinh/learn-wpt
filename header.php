...
<div id="loading"><div class="title"><img src="<?php echo get_template_directory_uri(); ?>/images/top/loading_title.png" alt="株式会社 MILBON" width="492"></div><div class="bar"><p>loading...100%</p><span></span></div></div>
  <div id="cover"></div>
...
<header id="header">
  <div class="header-block">
    ...
    <ul class="globalNavi">
      <li><a class="active pageLink" href="<?php echo esc_url( home_url( '/' ) );?>">TOP<span></span></a></li>
      <li><a class="pageLink" href="<?php echo esc_url( home_url( '/' ) ) . 'concept';?>">CONCEPT<span></span></a></li>
      <li><a class="pageLink" href="<?php echo esc_url(get_post_type_archive_link( 'milbon-brands' )); ?>">BRAND<span></span></a></li>
      <li><a class="pageLink" href="<?php echo esc_url( home_url( '/' ) ) . 'company_gaiyou';?>">COMPANY<span></span></a></li>
      <li><a class="pageLink" href="<?php echo esc_url(get_post_type_archive_link( 'milbon-news' )); ?>">NEWS<span></span></a></li>
      <li><a class="pageLink" href="<?php echo esc_url( home_url( '/' ) ) . 'contact'; ?>">CONTACT<span></span></a></li>
    </ul>
    <ul class="subMenu">
      <li class="submenu01"><a href="<?php echo esc_url( home_url( '/' ) ) . 'beauty'; ?>">FOR HAIR DESIGNER</a></li>
<!--       <li class="line"></li>
  ...
  <ul>
    <li>
      <a href="<?php echo esc_url( home_url( '/' ) ) . 'company_gaiyou';?>" class="pageLink">
        ...
        <div class="over"><span>COMPANY PROFILE<p>［ 会社概要 ］</p></span><p class="icon2">VIEW MORE →</p></div>
      </a>
    </li>
    <li>
      <a href="<?php echo esc_url( home_url( '/' ) ) . 'company_history';?>" class="pageLink">
        ...
        <div class="over"><span>OUR HISTORY<p>［ 社史 ］</p></span><p class="icon2">VIEW MORE →</p></div>
      </a>
    </li>
    <li>
      <a href="<?php echo esc_url( home_url( '/' ) ) . 'company_message';?>" class="pageLink">
        ...
        <div class="over"><span>MESSAGE<p>［ 社長挨拶 ］</p></span><p class="icon2">VIEW MORE →</p></div>
      </a>
    </li>
    <li>
      <a href="<?php echo esc_url( home_url( '/' ) ) . 'company_office';?>" class="pageLink">
        <img src="<?php echo get_template_directory_uri(); ?>/images/header_company_image04.jpg" height="126" width="224" alt="OUR OFFICE">
        <div class="defalt"><span>OUR OFFICE</span></div>
        <div class="over"><span>OUR OFFICE<p>［ 拠点一覧 ］</p></span><p class="icon2">VIEW MORE →</p></div>
      </a>
    </li>
<!--     <li>
